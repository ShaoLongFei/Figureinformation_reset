...
//                type="情报资源";
            ...
            //    showToast("当前为："+selectThree, false);
                break;
            case R.id.four:
...
//                type="全部资讯";
            ...
            //    showToast("当前为："+selectFour, false);
                break;
...
//                type="编译报道";
             ...
             //   showToast("当前为："+selectOneCopy, false);
                break;
            case R.id.threeCopy:
...
//                type="情报资源";
               ...
               // showToast("当前为："+selectThreeCopy, false);
                break;
            case R.id.fourCopy:
...
//                type="全部资讯";
              ...
              //  showToast("当前为："+selectFourCopy, false);
                break;
    ...
    private void changeToolbarAlpha() {
        ...
        //计算当前透明度比率
        float radio= Math.min(1,scrollY/(mRollViewPager.getHeight()-toolbar.getHeight()*1f));
        //设置透明度
