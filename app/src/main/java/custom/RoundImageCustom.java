...
public class RoundImageCustom extends ImageView {
    ...
    public RoundImageCustom(Context context, AttributeSet attrs) {
    ...
    public RoundImageCustom(Context context, AttributeSet attrs, int
            defStyle) {
