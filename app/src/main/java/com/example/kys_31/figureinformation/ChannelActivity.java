 ...
 * 频道管理
 */
public class ChannelActivity extends FirstPageBaseActivity implements OnItemClickListener
{
		...
		case R.id.userGridView:
			...
			if (position != 0 && position != 1) {
				...
				if (moveImageView != null) {
					...
					Log.e("TAG", "ADAPTER:"+parent.getAdapter());
	...
	public void onBackPressed() {
		...
		if(userAdapter.isListChanged()){
			...
			setResult(FirstPageFragment.CHANNELRESULT, intent);
			finish();
		}else{
			super.onBackPressed();
		}
