...
import com.example.liuyue.figureinformation_reset.BaseActivity;
 ...
 */
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.menuitem1:
                setBackground(0);
                metaballMenuImageView1.setEnabled(false);
                metaballMenuImageView2.setEnabled(true);
                metaballMenuImageView3.setEnabled(true);
                break;
            case R.id.menuitem2:
                setBackground(1);
                metaballMenuImageView1.setEnabled(true);
                metaballMenuImageView2.setEnabled(false);
                metaballMenuImageView3.setEnabled(true);
                break;
            case R.id.menuitem3:
                setBackground(2);
                metaballMenuImageView1.setEnabled(true);
                metaballMenuImageView2.setEnabled(true);
                metaballMenuImageView3.setEnabled(false);
                break;
        }
    }
