...
public class ChannelManage {
	...
	static {
		...
		defaultUserChannels.add(new ChannelItem(3, "食物营养", 3, 1));
		defaultUserChannels.add(new ChannelItem(4, "油气类", 4, 1));
		...
		defaultOtherChannels.add(new ChannelItem(9, "转基因生物", 2, 0));
		defaultOtherChannels.add(new ChannelItem(10, "农业污染防治", 3, 0));
		defaultOtherChannels.add(new ChannelItem(11, "宽带移动通信", 4, 0));
		defaultOtherChannels.add(new ChannelItem(12, "新药创制", 5, 0));
		defaultOtherChannels.add(new ChannelItem(13, "重大传染防治", 6, 0));
